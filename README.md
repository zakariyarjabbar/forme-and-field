...
The GitHub repository is private at [zakariyarjabbar/forme-and-field](https://github.com/zakariyarjabbar/forme-and-field). Repository access requires an authorized GitHub account; website social cards remain available in the source for a future public website deployment. The website itself is not deployed by pushing this repository; GitHub Pages cannot run its Node/SQLite commerce backend.
